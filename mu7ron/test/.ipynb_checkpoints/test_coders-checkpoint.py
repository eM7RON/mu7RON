    ...
    def test_categorize(self):
        ...
        for i in range(4):
            ...
            for j in range(7):
                ...
                result = coders.categorize_input(v['uncategorized'], p['q'], p['n_time'], p['off_mode'], p['time_encoder'], p['ekwa'])
                ...
                result = coders.decategorize_output(result, p['q'], p['n_time'], p['off_mode'], p['time_decoder'], p['dkwa'])
                
                self.assertTrue(analyze.is_equal_midi_sequences(v['decategorized'], result))
    ...
    def test_decategorize(self):
        ...
        for i in range(4):
            ...
            for j in range(7):
                ...
                result = coders.decategorize_output(v['categorized'], p['q'], p['n_time'], p['off_mode'], p['time_decoder'], p['dkwa'])
                self.assertTrue(analyze.is_equal_midi_sequences(v['decategorized'], result))
