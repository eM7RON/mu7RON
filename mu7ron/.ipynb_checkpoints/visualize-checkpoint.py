...
def bar_chart(
    adict, x_label='', y_label='', fig_title='', log_y=False, sort_y=False, 
    reverse_sort=False, rotate_y=False, tck_fmt='sci', **kwargs):
    ...
    plt.bar(x_pos,
            ...
            alpha=0.7, 
            color=[
                   '#0b1923', '#ff1188', '#ffee22', '#11bbcc', '#004150', 
                   '#087436', '#ffc300', '#ec5b1d', '#c70039', '#221131', 
                   '#12a3a7', '#a6159f'],
            ec='w',
             #log=True,
            )
